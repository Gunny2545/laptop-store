            ...
            <div classname="col-md-8 offset-md-2">
                <div className="container">
                    ...
                    <div className="mb-3 row">
                        ...
                        name="name" 
                        id="name" placeholder="name" onChange={handleInputChange}/>
                        </div>
                    </div>
                    ...
                    <div className="mb-3 row">
                        ...
                        <input type="text" className="form-control" 
                        name="email" 
                        id="email" placeholder="xxx@yyy.com" onChange={handleInputChange}/>
                        </div>
                    </div>
                    ...
                    <div className="mb-3 row">
                        ...
                        <input type="text" className="form-control" 
                        name="phone_number" 
                        id="phone_number" placeholder="xxx-xxx-xxxx" onChange={handleInputChange}/>
                        </div>
                    </div>
